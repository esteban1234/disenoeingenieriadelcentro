...
//To address and name
$mail->addAddress("info@disenoeingenieriadelcentro.com");



$mail->isHTML(true);

$mail->Subject = "Cotización Diseño e Ingenieria del Centro";
$mail->Body = "
              <!DOCTYPE html>
                <html>
                <head>
                ...
                <h1 style='text-align:center;  font-weight: bold'> Diseño e Ingenieria del Centro</h1>
